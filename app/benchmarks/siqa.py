...
# Load dataset
dataset = load_dataset("lighteval/siqa", split="validation") # Siqa does not have a test dataset split
# Load model
model_name_or_path = "TheBloke/Mistral-7B-v0.1-AWQ" #TheBloke/Mistral-7B-Instruct-v0.2-AWQ #TheBloke/Mistral-7B-v0.1-AWQ #solidrust/Nous-Hermes-2-Mistral-7B-DPO-AWQ 
