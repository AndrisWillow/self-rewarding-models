...
input_ds_location = os.path.join(script_dir, "EFT_seed_data_Lamma3.jsonl")
...
output_file_path = os.path.join(script_dir, "EFT_seed_data_2.jsonl")
...
filtered_output_file_path = os.path.join(script_dir, "EFT_seed_data_3.jsonl")
